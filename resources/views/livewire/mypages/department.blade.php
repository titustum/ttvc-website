    ...
    <div class="container px-4 mx-auto">
        ...
        <div class="mb-12 overflow-hidden bg-white rounded-lg shadow-md">
            ...
            <div class="p-8">
                <p class="mb-6 text-gray-700">
                    The ICT Department at Tetu TVC offers a wide range of programs to suit various educational needs and
                    career aspirations. Our courses are designed to equip students with the latest skills and knowledge
        ...
        <div class="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2 lg:grid-cols-3">
            <div class="p-6 text-center bg-white rounded-lg shadow-md">
                <img src="./images/team/DEPUTY-ACADEMICS-JAMES-KIHARA.jpeg" alt="HOD ICT"
            ...
            <div class="p-6 text-center bg-white rounded-lg shadow-md">
                <img src="./images/team/LYDIA-NDIRANGU-DP-ADMIN.jpeg" alt="ICT Trainer 1"
                    class="object-cover w-32 h-32 mx-auto mb-4 rounded-full">
            ...
            <div class="p-6 text-center bg-white rounded-lg shadow-md">
                <img src="./images/principal.png" alt="ICT Trainer 2"
                    class="object-cover w-32 h-32 mx-auto mb-4 rounded-full">
        ...
        <p class="mb-6 text-gray-700">Our department boasts modern computer labs equipped with the latest hardware and
...
<section class="py-12 text-white bg-orange-600">
    <div class="container px-4 mx-auto text-center">
        ...
        <p class="mb-8 text-xl">Join our ICT department and unlock a world of opportunities in the digital realm.</p>
        <a href="#"
