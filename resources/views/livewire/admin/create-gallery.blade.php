...
<div class="p-3">
    <main class="container px-8 py-8 mx-auto my-8 bg-white rounded-md">
        <h1 class="mb-6 text-3xl font-bold text-orange-600">Add Gallery</h1>
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700">Gallery Name</label>
            ...
            <div>
                <label for="category" class="block text-sm font-medium text-gray-700">Gallery Category</label>
