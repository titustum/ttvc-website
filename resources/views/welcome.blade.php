          ...
          <div class="flex flex-col justify-between h-full p-6 bg-white border rounded-lg shadow-md">
            <div>
              ...
              <div class="my-4 text-center">
                <img src="{{ asset('images/principal.png') }}"
                  class="h-[200px] w-[200px] object-cover mx-auto rounded-full shadow-lg" alt="Mrs. Catherine Gikoyo">
              </div>
              <div class="px-4 my-3 text-gray-700">
                <p class="mb-4">It's my pleasure to welcome you to Tetu Technical and Vocational College. We are
            ...
            <div class="mt-6 text-center">
              <a href="{{ route('administration') }}"
                class="inline-block px-6 py-2 text-white transition duration-300 bg-orange-600 rounded-full btn hover:bg-orange-700">
        ...
        <div data-aos='fade-up' class="w-full md:col-span-2 lg:col-span-2">
          <div class="grid h-full gap-6 md:grid-cols-2">
            <div class="flex flex-col justify-between text-white bg-blue-600 rounded-lg shadow-md">
              ...
              <div class="p-6 text-center">
                <a href="{{ route('admissions') }}"
                  class="inline-block px-4 py-2 text-blue-600 transition duration-300 bg-white rounded-full hover:bg-gray-200">
            ...
            <div class="flex flex-col justify-between text-white bg-green-600 rounded-lg shadow-md">
              ...
              <div class="p-6 text-center">
                <a href="{{ route('downloads') }}"
                  class="inline-block px-4 py-2 text-green-600 transition duration-300 bg-white rounded-full hover:bg-gray-200">
            ...
            <div data-aos='fade-up'
              class="flex flex-col justify-center text-white bg-yellow-600 rounded-lg shadow-md md:col-span-2">
              <div class="p-6">
                <h4 class="mb-3 text-xl font-bold text-center">Our Programs</h4>
                <p class="px-3 mb-4 text-center">Discover our wide range of technical and vocational programs designed
                  to equip you with industry-relevant skills.</p>
                <div class="text-center">
                  <a href="{{ route('courses') }}"
                    class="inline-block px-4 py-2 text-yellow-600 transition duration-300 bg-white rounded-full hover:bg-gray-200">
  ...
  <section class="py-16 bg-gray-100">
    <div class="container px-4 mx-auto">
      ...
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div data-aos='fade-up'
          class="overflow-hidden transition-transform bg-white rounded-lg shadow-md group hover:scale-105">
          ...
          <div class="p-6">
            ...
            <a href="{{ route('department', $department->name) }}"
              class="font-semibold text-orange-600 transition-colors duration-300 hover:text-orange-700">Learn More
              →</a>
          </div>
        </div>
        @endforeach
        ...
        <div data-aos='fade-up'
          class="flex items-center justify-center overflow-hidden transition-transform bg-orange-600 rounded-lg shadow-md hover:scale-105">
          <div class="p-6 text-center">
            ...
            <a href="{{ route('departments') }}"
              class="px-4 py-2 font-semibold text-orange-600 transition duration-300 bg-white rounded-full hover:bg-gray-100">View
              All Programs</a>
          </div>
        </div>
      </div>
    ...
    <div class="container px-4 mx-auto">
      ...
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div data-aos='fade-up' class="p-6 bg-gray-100 rounded-lg shadow-md">
          <img src="{{ asset('images/stories/plumbing-story.jpg') }}" alt="Jane Doe"
          ...
          <p class="text-gray-700">"Thanks to Tetu TVC, I now run my own successful welding store. The hands-on training
            I received was invaluable."</p>
        </div>

        <!-- Success Story 2 -->
        <div data-aos='fade-up' class="p-6 bg-gray-100 rounded-lg shadow-md">
          <img src="{{ asset('images/stories/fashion-story.jpg') }}" alt="John Smith"
            class="object-cover w-24 h-24 mx-auto mb-4 rounded-full">
          ...
          <p class="text-gray-700">"I can now make my own high quality garments and excel in my modelling journey.
            Thanks Tetu TVC."</p>
        </div>

        <!-- Success Story 3 -->
        <div data-aos='fade-up' class="p-6 bg-gray-100 rounded-lg shadow-md">
          <img src="{{ asset('images/stories/ict-story.jpeg') }}" alt="Mary Johnson"
            class="object-cover w-24 h-24 mx-auto mb-4 rounded-full">
          ...
          <p class="text-gray-700">"The skills I learned at Tetu TVC helped me secure a job at a leading tech company.
            I'm grateful for the practical education I received."</p>
        </div>
      </div>

      {{-- <div class="mt-12 text-center">
        <a href="/success-stories"
          class="inline-block px-6 py-3 font-semibold text-white transition duration-300 bg-orange-600 rounded-full hover:bg-orange-700">Read
  ...
  <section class="py-16 bg-cyan-100">
    <div class="container px-4 mx-auto">
      ...
      {{-- <div data-aos='fade-up' class="mt-12 text-center">
        <a href="/our-partners"
          class="inline-block px-6 py-3 font-semibold text-white transition duration-300 bg-orange-600 rounded-full hover:bg-orange-700">
